...
namespace InsertionNunitTest
{
    public class AddProductTest
    {
        ...
        //Helper function will help me to not to change codes in applciations class, this is independent method only for this class 
        ...
        [Test]
        public void AddingProductVerificationTest()
        {
            //A - Arrange
            products product = new products
            {
                ProductName = "NunitFruit2",
                ProductID = 2295485,
                AmountKG = 100,
                PricePerKG = 10
            };
            ...
            //A - Act
            Response response = apps.AddProduct(con, product);

            //A - Assert
            Assert.AreEqual(200, response.statusCode);
            Assert.AreEqual("product is added successfully", response.message);
